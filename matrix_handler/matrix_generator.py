...
def generate_matrix(
    rows, columns, init_val=0, end_val=9,
    file_name='matrix.txt', file_path=os.getcwd()
):
    ...
    ---------
        ...
        init_val : int
            the initial value of the range of values of the matrix
            default: 0
        end_value : int
            the end value of the range of values of the matrix
            default: 9
        file_name : str
            the name of the file in which the matrix will be saved
            default: 'matrix.txt'
        file_path : str
            the path where the matrix file will be saved
